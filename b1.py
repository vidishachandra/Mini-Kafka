...
from broker import multi_threaded_client
...
dst = 'C:\\Users\\tanus\\Desktop\\sem5\\BD\\BD project\\topics1'
shutil.copytree(src, dst) 

def broker1():
    host = socket.gethostname()
    port1 = 5001  # initiate port1 no above 1024
    ...
    while True:
        ...
        # shutil.copyfile("logcopy.txt","log_b1.txt")
